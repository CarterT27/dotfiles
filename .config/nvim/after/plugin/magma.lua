-- Key mappings
vim.api.nvim_set_keymap('n', '<Leader>r', "<cmd>MagmaEvaluateOperator<CR>", { silent = true, expr = true })
vim.api.nvim_set_keymap('n', '<Leader>rr', "<cmd>MagmaEvaluateLine<CR>", { silent = true })
...
local function MagmaInitPython()
    ...
    vim.cmd('MagmaEvaluateArgument a=3')
end
